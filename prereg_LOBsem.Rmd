...
meta() %>%
  ...
  meta_social(
    ...
    url = "https://lewendm.github.io/slides/prereg_LOBsem.html",
    image = "https://lewendm.github.io/slides/images/social-card.png",
    image_alt = paste(
...
class: center, middle
# Why preregister?
### `r emo::ji("keycap_2")`Mitigates (some) poor research practices and biases.
